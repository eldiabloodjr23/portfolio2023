...
const Footer = () => {
  ...
  <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div class="text-center">
      ...
      Explore my portfolio to see some of my recent projects and get a taste of what I can bring to the table.
      </p>

      <a
        href="#"
        class="mt-8 inline-block rounded-full border border-red-600 px-12 py-3 text-sm font-medium text-red-600 hover:bg-red-600 hover:text-white focus:outline-none focus:ring active:bg-red-500"
      >
        Hire me
      </a>
    </div>
